            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab1">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" ng-model="liq.codoperador" ng-keypress="buscaroperador(liq.codoperador,$event,'normal')" style="width:50px;">
                          ...
                          <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-2">
                                        <button type="button" class="btn btn-success" ng-click="buscaroperador('x',$event,'normal')">Buscar</button>
                                      </div>
                                      <table class="table m-b-none table-hover" ui-jq="footable" data-filter="#filter" data-page-size="30">
                                        ...
                                        <tr ng-repeat="operador in operadores|filter:buscar">
                                          <td><button type="button" ng-click="sel(operador.ID, operador.COD_OPERADOR, operador.APELLIDOS, operador.NOMBRES,'normal') " class="btn btn-success" data-dismiss="modal">{{operador.COD_OPERADOR}}</button></td>
                                          <td>{{operador.ID}}</td>
                             ...
                             <div class="motivar">
                            <label for="" ng-show="mostrar">Operador interno:</label>
                            <input type="hidden" ng-model="liq.idoperadorint">
                            <input id="opeint" disabled ng-model="liq.opeint" ng-show="mostrar" type="text" style="width:50px;"> 

                              <a href="" ng-show="mostrar" ng-click="clear()" data-toggle="modal" data-target="#myModal2"><i class="icon-magnifier icon text-success-lter"></i></a>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                           <!--<button type="button" class="btn btn-success" ng-click="buscarliq()" id="buscar">Buscar</button>-->

                          <div ng-show="mostrar" class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" ng-click="clear()"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                  ...
                                  <div class="modal-body">
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-2">
                                        <button type="button" class="btn btn-success" ng-click="buscaroperador('x',$event,'interno')">Buscar</button>
                                      </div>
                                      <table class="table m-b-none table-hover" ui-jq="footable" data-filter="#filter" data-page-size="30">
                                        <thead>
                                          <tr>
                                        ...
                                        <tbody></tbody>
                                        <tr ng-repeat="operador in operadores|filter:buscar">
                                          <td><button type="button" ng-click="sel(operador.ID, operador.COD_OPERADOR, operador.APELLIDOS, operador.NOMBRES, 'interno') " class="btn btn-success" data-dismiss="modal">{{operador.COD_OPERADOR}}</button></td>
                                          <td>{{operador.ID}}</td>
                                          <td>{{operador.COD_OPERADOR}}</td>
                                          <td>{{operador.APELLIDOS}}</td>
                                          <td>{{operador.NOMBRES}}</td>
                            ...
                            <label ng-show="mostrar" for="">Motivo</label>
                              <select  ng-show="mostrar" name="mot" id="mot" ng-model="liq.moti" ng-init="motivos()" ng-options="moti as moti.DESCRIPCION for moti in motivos">
                                <option value="">Selecione motivo</option>
                              </select>
                              <label ng-show="mostrar" for="">Glosa</label>
                              <input ng-show="mostrar" id="glosa" ng-model="liq.glosa" type="text" style="width:350px;">
                         ...
                         <table class="table  table-bordered"  >
                          ...
                          <tfoot>
                           ...
                           <th class="warning">Motivados:{{getTotalmot()}}</th>
