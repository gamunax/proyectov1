...
class Dashboard extends MX_Controller
{
    public function __construct(){
        parent::__construct();
        $this->load->model('ubigeo_territorio_model', 'ubigeo', TRUE);
    }
     ...
     public function index()
    {
        ...
        ## Inicio de Sesión
        $data['page_title'] = 'Maestro de Ubigeo territorio';

        ## Template Admin Dashboard
        $data['module'] = 'ubigeo_territorio';
    ...
    public function liquidacion_insertar(){
        ...
        foreach ($array as $value) {
               ...
               // $remito    = $dt_remito['REMITO_INI'] + 1;
                ...
                'FECHA_SALIDA' => $fecha_salida,//$value['fechasalida'],
