        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab1">
                    ...
                    <?php echo form_open_multipart('remito_ca/dashboard/cu_create_remito','class="form-horizontal"');?>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <a href="<?php echo base_url().'remito_ca/dashboard'; ?>" class="btn btn-default">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    <?php echo form_close();?>
...
<script type="text/javascript">
    function metod_confirm (id) {
        ...
        if (r == true) {
            window.location = "<?php echo base_url(); ?>remito_ca/dashboard/remito_edit/"+id;
        } else {
            //Cancelado
        }
    }
