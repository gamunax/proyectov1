...
class orden_servicio_model extends CI_Model {
    ...
    public function return_os($fecha1, $fecha2, $estado,$documento){
        ...
        $query = $this->db->query("select ID, NRO_ORDEN, DOCUMENTO, NROCLIENTE, FECHA_ORDEN, CANT_ENVIOS, GLOSA, TIPO_SERVICIO from orden_servicio where FECHA_ORDEN >= '$fecha1' and FECHA_ORDEN <= '$fecha2' and ESTADO = '$estado' and (DOCUMENTO='$documento' or '$documento'= '%')");
