        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab1">
                    ...
                    <?php echo form_open_multipart('tarifa/dashboard/cu_create_tarifa','class="form-horizontal"');?>
                        ...
                        <div class="form-group">
                             <label class="col-sm-1 control-label">Tarifa Base </label>
                            <div class="col-sm-5">
                                <?php echo form_input($tfabase); ?>
                            </div>
                        

                            <label class="col-sm-1 control-label">tarifa Exceso: </label>
                            <div class="col-sm-5">
                                <?php echo form_input($tfaexceso); ?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <?php
                                    echo form_dropdown('idservicio',$servicio,$idservicio,'class="form-control m-b"  style="margin-bottom:0px;"');
                                ?>
                            </div>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <a href="<?php echo base_url().'tarifa/dashboard'; ?>" class="btn btn-default">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    <?php echo form_close();?>
...
<script type="text/javascript">
    function metod_confirm (id) {
        ...
        if (r == true) {
            window.location = "<?php echo base_url(); ?>tarifa/dashboard/tarifa_edit/"+id;
        } else {
            //Cancelado
        }
    }
