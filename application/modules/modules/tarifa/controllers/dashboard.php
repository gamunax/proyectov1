...
class Dashboard extends MX_Controller
{
    ...
    public function create_tarifa(){
        ...
        $data['servicio'] = $this->tarifas->_lst_cbo_servicios();
        $data['idservicio'] = '';
    ...
    public function cu_create_tarifa(){
        ...
        if ($this->form_validation->run() == true)
        {
            ...
            $tfabase     = $this->input->post('tfabase');
            $tfaexceso   = $this->input->post('tfaexceso'); 
            ...
            if(!empty($id)){//ENTRA CUANDO ID TIENE VALOR
                ...
                */
                ...
                //if(is_array($imagen)){
                 $upd = $this->tarifas->update_tarifa($arr_datos,(int)$id);
                 if($upd) {
                ...
                $ins_datos = $this->tarifas->_insert_tarifas($arr_datos);
                if($ins_datos){
    ...
    public function delete($id,$tipo = null){
        ...
        $this->tarifas->update_tarifa($additional_data,$id);
        // $this->session->set_flashdata('message', 'delete');
        redirect(base_url().'tarifa/dashboard','refresh');
    }
    ...
    public function tarifa_edit($id = NULL){
        ...
        if(count($dt_tarifa)!=0){
            ...
            $data['id']          = $dt_tarifa['ID'];
             ...
             $data['servicio'] = $this->tarifas->_lst_cbo_servicios();
             $data['idservicio'] = $dt_tarifa['ID_SERVICIO']; 
