...
<div class="wrapper-md">
    <div class="tab-container">
        ...
        <ul class="nav nav-tabs" role="tablist">
         ...
         <?php echo form_open_multipart('proyectos/dashboard/cu_create_proyecto','class="form-horizontal"');?>
                ...
                <div class="tab-pane active" id="tab1">
                    <div class="form-horizontal">
                       ...
                       <!-- <div class="form-group">
                        ...
                        <?php echo form_hidden('idtipoinmueble', '17');?>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Proximo Proyecto?: </label>
                            <div class="col-sm-8">
                                <?php echo form_input($proximoproyecto); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Grado de Conservación: </label>
                            <div class="col-sm-8">
                                <?php
                                    echo form_dropdown('idconservacion',$gradoconservacion,$idconservacion,'class="form-control m-b" required="required" style="margin-bottom:0px;"');
                                ?>
                            </div>
                        </div>
                 ...
                 <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <a href="<?php echo base_url().'proyectos/dashboard'; ?>" class="btn btn-default">Cancelar</a>
                                    </div>
                                </div>
                 </div>
            </div>
