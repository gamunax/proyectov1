...
class Dashboard extends MX_Controller
{
    ...
    {
        parent::__construct();
         $this->load->model('reporte_model','reportes', TRUE);
    ...
    // public function mostrar_reportexremito($fecha1, $fecha2){
        
    //     $data = $this->reporte->return_reportexremito($fecha1, $fecha2);
    //     echo json_encode($data);
    // }



    public function reportexremito()
    {   
        
        
        
        $this->load->view('reportexremito');
        
    }

    public function buscar_reportexremito(){
        ...
        $data = $this->reportes->return_reportexremito($fechaini, $fechafin, $estado, $documento);
        echo json_encode($data);
    }

    public function buscar_estado(){
        $data = $this->reportes->buscar_estado();
        echo json_encode($data);
    }
