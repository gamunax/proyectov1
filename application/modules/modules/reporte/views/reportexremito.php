...
<br><br>
			...
			<div class="col-sm-3">
				...
				<button type="button" id="agregar"  ng-click="reportexremito(fechain,fechater, reporte.estado.CODIGO,rucdni)" data-target=".bs-example-modal-lg" class="btn btn-success">Buscar</button>
			</div>
