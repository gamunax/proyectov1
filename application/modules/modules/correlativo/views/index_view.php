<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3">Maestro de Correlativos</h1>
</div>
      ...
      <div class="panel panel-default">
        ...
        <div style="margin-bottom: 25px;">
          <table class="table m-b-none" ui-jq="footable" data-filter="#filter" data-page-size="12">
            ...
            <tbody>
              <?php if(!empty($correlativos_general)): ?>
                <?php foreach ($correlativos_general as $correlativo) : ?>
                  <tr>
                      <td><?php echo $correlativo->NOM_OFICINA; ?></td>
                      
                      <td><?php echo $correlativo->NOM_TIPODOC; ?></td>
                      <td><?php echo $correlativo->SERIE; ?></td>
                      <td><?php echo $correlativo->NUMERO; ?></td>
                      <td>
                        <a href="#edit" onclick="edit(<?php echo  $correlativo->ID ?>);"  title="Editar" class="btn btn-default">
...
<script type="text/javascript">
    function metod_confirm (id) {
        ...
        if (r == true) {
            window.location = "<?php echo base_url(); ?>correlativo/dashboard/delete/"+id;
        } else {
            //Cancelado
        }
    }
    function edit(id){
        ...
        $("#content-ajax #content").load("<?php echo base_url(); ?>correlativo/dashboard/correlativo_edit/"+id);
        $("#content-ajax").removeClass("hidden");
        $("#content-ajax").addClass("block");
    }
    function create(){
        $("#content-ajax #content").load("<?php echo base_url(); ?>correlativo/dashboard/create_correlativo");
        $("#content-ajax").removeClass("hidden");
        $("#content-ajax").addClass("block");
    }
