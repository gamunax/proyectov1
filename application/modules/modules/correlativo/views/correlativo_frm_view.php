        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab1">
                    ...
                    <?php echo form_open_multipart('correlativo/dashboard/cu_create_correlativo','class="form-horizontal"');?>
                         <?php echo form_hidden('id', $id);?> 
                        <div class="form-group">
                             <label class="col-sm-1 control-label">Oficina: </label>
                            <div class="col-sm-5">
                                <?php
                                    echo form_dropdown('idoficina',$oficina,$idoficina,'class="form-control m-b"  style="margin-bottom:0px;"');
                                ?>
                            </div>
                             <label class="col-sm-2 control-label">Tipo Doc: </label>
                            <div class="col-sm-4">
                                <?php
                                    echo form_dropdown('idtipodoc',$tipodoc,$idtipodoc,'class="form-control m-b"  style="margin-bottom:0px;"');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <a href="<?php echo base_url().'correlativo/dashboard'; ?>" class="btn btn-default">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    <?php echo form_close();?>
...
<script type="text/javascript">
    function metod_confirm (id) {
        ...
        if (r == true) {
            window.location = "<?php echo base_url(); ?>correlativo/dashboard/correlativo_edit/"+id;
        } else {
            //Cancelado
        }
    }
