        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab1">
                    ...
                    <?php echo form_open_multipart('producto/repuestos/cu_create_producto','class="form-horizontal"');?>
                        
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Nombre: </label>
                            <div class="col-sm-10">
                                <?php echo form_hidden('tipo', 'repuestos');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php
                                if(!empty($img_print)){
                                    echo '<img src="'.base_url().'uploads/producto/'.$id_producto.'/thumbs/'.$img_print.'" class="img-responsive" style="margin-bottom:10px">';
                                } 
