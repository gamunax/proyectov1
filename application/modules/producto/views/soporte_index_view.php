    ...
    <div class="panel panel-default">
        ...
        <div style="margin-bottom: 25px;">
            <table class="table m-b-none" ui-jq="footable" data-filter="#filter" data-page-size="5">
                ...
                <tbody>
                <?php if(!empty($tecnico_general)): ?>
                    <?php foreach ($tecnico_general as $tecnico) : ?>
                        <tr>
                            <td><?php echo $tecnico->pag_titulo?></td>
                            <td>
                                <a href="<?php echo base_url().'producto/dashboard/ver_tecnico/'.$tecnico->pag_id ?>"  title="Editar" class="btn btn-default">
                                    <i class="fa icon-eye"></i>
                                    Ver
                                </a>
                                <!--
                                <a href="#" onclick="return metod_confirm(<?php echo  $tecnico->pag_id ?>);" title="Eliminar" class="btn btn-danger">
