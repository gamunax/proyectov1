                    ...
                    <?php foreach ($slider_general as $slider) : ?>
                      <tr>
                        ...
                        <span class="label bg-<?php echo $slider->slide_estado == 0 ? 'danger' : 'success'; ?>" title="Active">
                          <?php echo $slider->slide_estado == 0 ? 'Anulado' : 'Activo'; ?>
                        </span>
                      </td>
                      ...
                      <td>
                        ...
                        <?php
                        if($slider->slide_estado == '0'){ ?>
                            <a href="#" onclick="return metod_confirm('<?php echo  $slider->slide_id;?>);" title="Activar" class="btn btn-default">
                                <i class="fa fa-times-circle-o"></i>
                                Activar
                            </a>
                        <?php }else{ ?>
                            <a href="#" onclick="return metod_confirm('<?php echo $slider->slide_id; ?>);" title="Desactivar" class="btn btn-default">
                                <i class="fa fa-times-circle-o"></i>
                                Anular
                            </a>
                        <?php }?>
...
<script type="text/javascript">
    ...
    function edit(id){
        ...
        $("#content-ajax #content").load("<?php echo base_url(); ?>producto/equipos/producto_edit/"+id);
        $("#content-ajax").removeClass("hidden");
        $("#content-ajax").addClass("block");
    }
    function create(id){
        $("#content-ajax #content").html("");
        $("#content-ajax #content").load("<?php echo base_url(); ?>producto/equipos/create_producto/");
        $("#content-ajax").removeClass("hidden");
        $("#content-ajax").addClass("block");
    }
</script>