...
class Dashboard extends MX_Controller
{
    public function __construct(){
        parent::__construct();
        $this->load->model('consulta_model', 'consultas', TRUE);
    }
     ...
     public function index()
    {
        ...
        ## Inicio de Sesión
        $data['page_title'] = 'Consulta y Edición de remito';

        ## Template Admin Dashboard
        $data['module'] = 'consulta';
        $data['view_file'] = 'consulta_edicion_remito/index_view';
    ...
    public function create_envio(){
       ...
       // $data['idcategoria'] = 0;
        ...
        ## Template Admin Dashboard
        $data['module'] = 'envio';
        $data['view_file'] = 'envio/index_view';
        echo Modules::run('template/header_login',$data);
        echo Modules::run('template/admin',$data);
        echo Modules::run('template/footer_admin',$data);
