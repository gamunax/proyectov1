...
<div class="app app-header-fixed">
  <div class="container w-xxl w-auto-xs" id="sha" ng-controller="SigninFormController" ng-init="app.settings.container=false;" style="margin-right:auto !important;">
    <a href class="navbar-brand block m-t">MARMAT</a>
    <div class="col-xs-12">
            <img src="<?php echo base_url().'assets/admin/img/login-avatar.png';?>" class="img-responsive" id="avatar">
          </div>
    <div class="m-b-lg">
