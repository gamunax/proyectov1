...
*************************************************************
*/
class Envioca extends MX_Controller
{
     ...
     public function index()
    {
        ...
        $data['module'] = 'envio';
        $data['view_file'] = 'enviocargoadjunto/index_view';
    ...
    public function envio_insertar(){
       ...
       // $fecha_actual = date('d/m/Y',strtotime($fecha_actual));
        ...
        foreach ($array as $value) {
            ...
            $remitos = (string)$remitos2 . (string)$ins_datos . "-";
            if($ins_datos){
    ...
    public function create_envio(){
       ...
       // $data['idcategoria'] = 0;
        ...
        $data['page_title'] = 'REGISTRAR ENVIO MANUAL';
        ## Template Admin Dashboard
        $data['module'] = 'envio';
        $data['view_file'] = 'enviocargoadjunto/index_view';
        echo Modules::run('template/header_login',$data);
