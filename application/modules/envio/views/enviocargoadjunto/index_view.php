                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Detalle del remito</h4>
                             <div class="form-group">
                               <label class="col-sm-1 control-label">Lectora: </label>
                               <div class="col-sm-4">
                                <input type="text" class="form-control" ng-model="codigobarras" ng-keypress="lecturacodbarras(codigobarras, $event)">
                               </div>

                               <label class="col-sm-1 control-label">Emisión: </label>
                               <div class="col-sm-2">
                                <input type="text" class="form-control" ng-model="envio.emi" disabled>
                               </div>

                               <label class="col-sm-1 control-label">Remito: </label>
                               <div class="col-sm-2">
                                <input type="text" class="form-control" ng-model="envio.rem" disabled>
                               </div>
                             </div>
                          </div>
                          <div class="modal-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <button type="button" ng-click="enviarca()" class="btn btn-primary">Guardar</button><label>{{cargando}}</label>
