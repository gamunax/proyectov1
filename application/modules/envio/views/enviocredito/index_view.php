    ...
    <div class="col-md-12" id="content-ajax">
        <div class="panel panel-default" id="content">
          <div class="panel-heading"><?php echo $page_title;?>&nbsp;&nbsp;&nbsp; 
             &nbsp;&nbsp;&nbsp;Emisión OS:<input type="text" id="emiorden" ng-model="emiorden" >&nbsp;&nbsp;&nbsp; Número OS:<input type="text" id="nroorden" ng-model="nroorden" ng-keypress="findos($event, emiorden, nroorden)" > <input type="hidden" id="valida" value="1">
          </div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab1">
                    ...
                    <?php echo form_open_multipart('envio/enviocre/cu_create_cliente','class="form-horizontal"');?>
