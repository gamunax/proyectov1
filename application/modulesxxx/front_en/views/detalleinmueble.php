...
<div class="container" style="padding-bottom:40px;padding-left:0px;padding-right:0px;">
	...
	<div class="col-md-6" style="padding-left:0px;padding-right:0px;">
		...
		<div class="mapaplanodetalle">
			...
			<span style="font-family:gotham_htfmedium_italic;font-size:18px;color:#848484;">PLANE</span>
			</div>
			
		</div>
	<div class="col-md-12 det1">
		<div id="detalle_result" class="col-md-12 result_detalle det2"> 
						<ul style="list-style:none;padding-left:0px;margin-bottom:0px;font-family:gotham_htf_lightregular;">
							<li class="det4"><strong><?php echo $area; ?></strong><br>AREA</li>
							<li class="det4"><strong><?php echo $habitacion; ?></strong></strong><br>ROOM</li>
							<li class="det5"><strong><?php echo $banos; ?></strong><br>BATHROOMS</li>
