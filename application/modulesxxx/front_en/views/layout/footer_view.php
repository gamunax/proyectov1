	...
	<div class="container" style="padding-left:0px;padding-right:0px;">
		<div class="row" style="padding-left:0px;margin-left:0px;padding-bottom:50px;">
			<div class="col-md-12 footerproximos">
				...
				<a href="<?php echo base_url() ?>projects" class="masproyectosen desktop" style="float:right;"></a>
			
			</div>
			<div class="col-md-12">
			<a href="<?php echo base_url() ?>projects" class="masproyectosen phone" style="float:right;"></a>
		</div>
			<div class="cold-md-12 pagi pull-right" style="padding-right:20px;padding-top:10px;">
					<ul>
			...
			<div class="center-block">
				<ul style="list-style-type:none; " class="footerproy">
					<li  ng-repeat="inmueble in pagedItems[currentPage]">
						<div class="col-md-3 ultiproy" style="">
							  <div class="fondoultiproy "  ng-mouseenter="changemouse();"  ng-mouseleave="changeleave();">
								...
								<div class="caption detalle " style="background-color:#ffffff;text-align:justify;color:#929AA2;">
						              ...
						              <p style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:10px;margin-bottom:0px;word-wrap: break-word;">
						              	{{inmueble.descripcionIngles}}<a href="<?php echo base_url() ?>detailproperty/{{inmueble.idinmueble}}/{{inmueble.idcodinmueble}}"> See More</a></p>
	...
	<div class="container">
		<div class="row">
				<div class="col-md-3" style="padding-bottom:10px;color:#8A8A8A;">
					...
					<img src="<?php echo base_url() ?>assets/img/logo-map-azul.png" class="img-responsive" style="padding: 0 50px">
					</div>
					<form ng-submit="sendmail();" class="">
					<input id="nombre" ng-model="nombre" class="form-control input-lg" type="text" placeholder="Name" required style="margin-bottom:10px;color:#8A8A8A;">
					...
					<input id="mensaje" ng-model="comentario" class="form-control input-lg" type="text" placeholder="Message" required style="margin-bottom:10px;color:#8A8A8A;">
					
					<button type="button " style="cursor:pointer;margin-left:77%;font-family:gotham_htfbold;color:#ffffff;font-size:16.36px;" class="btn btn-link">Send</button>
					{{success3}}
					</form>
				</div>
				<div class="col-md-3 footera" >
					<div class="footercolor" style="font-family:gotham_htfbold;" >FOLLOW US</div>
				...
				<div class="col-md-2 linkfo" style="color:#ffffff;">
					...
					<div class="" style="display:block;padding-bottom:0px;padding-top:10px;border-bottom:1px solid #ffffff;font-family:gotham_htf_lightregular;"><a href="<?php echo base_url().'nosotros' ?>" class="subrafooter" style="color:#ffffff;">The Company</a></div>
					<div class="" style="display:block;padding-bottom:0px;padding-top:10px;border-bottom:1px solid #ffffff;font-family:gotham_htf_lightregular;"><a href="<?php echo base_url().'nuestroservicios' ?>" class="subrafooter" style="color:#ffffff;">Our Services</a></div>
					<div class="" style="display:block;padding-bottom:0px;padding-top:10px;border-bottom:1px solid #ffffff;font-family:gotham_htf_lightregular;"><a href="<?php echo base_url().'necesitaunsinmueble' ?>" class="subrafooter" style="color:#ffffff;">I want to buy a property</a></div>
					<div class="" style="display:block;padding-bottom:0px;padding-top:10px;border-bottom:1px solid #ffffff;font-family:gotham_htf_lightregular;"><a href="<?php echo base_url().'tienesuninmueble' ?>" class="subrafooter" style="color:#ffffff;">I want sell</a></div>	
					<div class="" style="display:block;padding-bottom:0px;padding-top:10px;border-bottom:1px solid #ffffff;font-family:gotham_htf_lightregular;"><a href="<?php echo base_url().'contactenos' ?>" class="subrafooter" style="color:#ffffff;">Contact</a></div>	
						
				</div>
					<div class="col-md-3" style="padding-left:0px;">
					<div class="footercolor" style="font-family:gotham_htfbold;" >CONTACTS</div>
					<div style="padding-bottom:30px;"><span class="icon-location" style="color:#ffffff;font-size:15px;background-color:#006EA6;padding:10px;"></span><span class="footerdireccion">Ave. Tomas Marsano 2875 Int. 607 Surco - Lima<span style="color:#004384;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div>
	...
	<div class="container-fluid fondocelesfooter" >
		<div class="container">
			<div class="col-md-12 copy">
							...
							<a style="color:#ffffff;" target="blank" href="http://www.studiomanda.pe">Powered by studiomanda.pe</a>
