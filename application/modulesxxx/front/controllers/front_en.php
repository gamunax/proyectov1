...
class Front_en extends MX_Controller
{
    ...
    public function buscar($av, $dep, $prov, $dis, $gradocon, $area, $tipoinmueble, $tipomoneda, $preciodesde, $preciohasta, $dormitorio, $bano, $cochera, $descripcion){
           if(empty($av)){
                $av = "%";
        ...
        $data = $this->front->resultado($av, $dep, $prov, $dis, $gradocon, $area, $tipoinmueble, $tipomoneda, $preciodesde, $preciohasta, $dormitorio, $bano, $cochera, $descripcion);
