...
<div id="header" class="container homelogo desktop" >
    ...
    -->
    <div class="phone desktop" style="width:150px;float:right;font-family:arial;font-size:13px;">
		...
		<div class="col-md-9" style="padding-left:0px;padding-right:0px;width:72.9%;">
...
<div id="header2" class="container homelogo phone" >
                            ...
                            <ul class="nav navbar-nav" style="margin-top:30px;background-color:#D7DFE6;text-align:center;">
                                ...
                                <li class="<?php echo $activetienesuninmueble ;?> menunecesitas dropdown">
                                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                    COMPRA / VENTA INMUEBLE <span class="caret"></span>
                                  </a>
                                  <ul class="dropdown-menu" >
                                  
                                    <li style=""><a href="<?php echo base_url().'necesitaunsinmueble' ?>">DESEO COMPRAR UN INMUEBLE</a></li>
                                    <li><a href="<?php echo base_url().'tienesuninmueble' ?>">DESEO VENDER MI INMUEBLE</a></li>
...
<div id="carousel-example-generic" class="carousel slide desktop" data-ride="carousel">
  <!-- Indicators -->
  <ol class="carousel-indicators">
    <?php
      ...
      /* echo $slide->dslide_id;*/

    ?>
    <li data-target="#carousel-example-generic" data-slide-to="<?php echo  $sliderc;?>" class="<?php echo $active; ?>"></li>
    <?php
    $sliderc++;
      endforeach;
    ?>
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item <?php echo  $active;?>">
      <img src="<?php echo base_url() ?>uploads/slider/1/<?php  echo $slide->dslide_imagen; ?>" class="img-responsive fondo">
      <div class="container">
        <div class="row">

        <div class="carousel-caption" style="top:350px;font-family:gotham_htfmedium;">
          <?php if(!isset($slide->dslide_nombre)){ ?>
         <div class="col-md-3 col-lg-4 tithome " style="text-align:left;font-size:53px;background:#3E97C9;margin-bottom:10px;"><?php echo $slide->dslide_nombre;?></div><br><br><br><br><br>
         <div class="col-md-7 col-lg-9 textohome" style="text-align:left;font-size:42px;background:#3E97C9;"><?php echo $slide->slide_nombre2;?></div>
        <?php } ?>
        </div>
      </div>
      </div>
...
<div id="carousel-example-generic" class="carousel slide phone responsive" data-ride="carousel">
  <!-- Indicators -->
  <ol class="carousel-indicators">
    <?php
        $sliderc = 0;
