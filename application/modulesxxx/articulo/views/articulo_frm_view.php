        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab1">
                    ...
                    <?php echo form_open_multipart('articulo/dashboard/cu_create_articulo','class="form-horizontal"');?>
                        
                        <div class="form-group">
                            <label class="col-sm-1 control-label">Abreviatura: </label>
                            <div class="col-sm-2">
                                <?php echo form_input($abreviatura); ?>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <a href="<?php echo base_url().'articulo/dashboard'; ?>" class="btn btn-default">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    <?php echo form_close();?>
