...
*************************************************************
*/
class Repuestos extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $data['productos_general'] = $this->productos->_lst_productos('repuestos');
        ## Inicio de Sesión
        $data['page_title'] = 'Repuestos';

        ## Template Admin Dashboard
        $data['module'] = 'producto';
        $data['view_file'] = 'repuestos/lst_repuestos_view';
    ...
    public function create_producto(){
       ...
       // $data['estado_detail'] = '';
        ...
        ## Template Admin Dashboard
        $data['module'] = 'usuario';
        $data['view_file'] = 'repuestos/producto_frm_view';
        //echo Modules::run('template/header_login',$data);
    ...
    public function delete_detail($id,$prod,$tipo = null){
        ...
        redirect(base_url().'producto/repuestos/producto_edit/'.$prod,'refresh');
    }
    ...
    public function delete($id,$tipo = null){
        ...
        // $this->session->set_flashdata('message', 'delete');
        redirect(base_url().'producto/repuestos','refresh');
    }
